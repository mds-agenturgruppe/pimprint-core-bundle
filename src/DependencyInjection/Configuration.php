    ...
    private function addProjectConfig(ArrayNodeDefinition $rootNode)
    {
        $rootNode->children()
                    ->arrayNode('lc_numeric')
                        ->info('Optional locales to set in render mode to have floats converted to .-strings')
                    ...
                    ->arrayPrototype()
                        ->children()
                            ...
                            ->booleanNode('create_update_info')->defaultValue(true)
                                ->info('Toggles creation of update info textbox.')->end()
                            ...
                            ->arrayNode('assets')->isRequired()
                                ...
                                ->children()
                                    ...
                                    ->booleanNode('pre_download')->defaultValue(false)
