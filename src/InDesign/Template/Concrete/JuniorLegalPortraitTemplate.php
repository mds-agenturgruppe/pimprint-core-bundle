 ...
 */
class JuniorLegalPortraitTemplate extends AbstractTemplate
{
    /**
     * Junior Legal portrait page width in mm.
     *
     * @var float
     */
    ...
    /**
     * Junior Legal portrait page height in mm.
     *
     * @var int
     */
    const PAGE_HEIGHT = 203;
}
